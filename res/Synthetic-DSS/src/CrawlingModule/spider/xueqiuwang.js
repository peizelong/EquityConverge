...
function md5(str){
    var fC = f0
    //Ju = "https://xueqiu.com/query/v1/symbol/search/status.json?count=10&comment=0&symbol=SH600276&hl=0&source=all&sort=time&page=1&q=&type=11"
    JP = J[fC(PX.J3)](J[fC(PX.J4)](J[fC(PX.J5)](J[fC(PX.J6)](J[fC(PX.J7)](sig(str), '|'), J[fC(PX.J9)](J9)), '|'), new Date()[fC(PX.JJ)]()), '|1')
    Ju = Jf['ua'](JP, true)
    return Ju
    //console.log(Ju) 
}
...
console.log(encodeURIComponent(md5(process.argv[2])));
